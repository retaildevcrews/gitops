...
> Note: This is part of the Azure Kubernetes Service (AKS) Secure Baseline Cluster reference implementation

This is part of the GitOps configuration. These Kubernetes object files are expected to be deployed via the in-cluster Flux operator. They are our AKS cluster's baseline configurations. Generally speaking, they are workload agnostic and tend to all cluster-wide configuration concerns.
